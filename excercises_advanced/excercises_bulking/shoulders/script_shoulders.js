...
const ex1Opener=()=>{
    fadeOutAndRedirect('standing_military_press.html');
}

const ex2Opener=()=>{
    fadeOutAndRedirect('dumbbell_lateral_raises_drop_sets.html');
}
const ex3Opener=()=>{
    fadeOutAndRedirect('arnold_press.html');
}

const ex4Opener=()=>{
    fadeOutAndRedirect('behind_neck_barbell_press.html');
}

const ex5Opener=()=>{
    fadeOutAndRedirect('cable_face_pulls.html');
}
