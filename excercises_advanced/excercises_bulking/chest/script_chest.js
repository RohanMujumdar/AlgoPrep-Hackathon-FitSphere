...
const ex1Opener=()=>{
    fadeOutAndRedirect('plyometric_push_ups.html');
}

const ex2Opener=()=>{
    fadeOutAndRedirect('weighted_chest_dips.html');
}
const ex3Opener=()=>{
    fadeOutAndRedirect('barbell_bench_press.html');
}

const ex4Opener=()=>{
    fadeOutAndRedirect('single_arm_bench_press.html');
}

const ex5Opener=()=>{
    fadeOutAndRedirect('decline_bench_press_pauses.html');
}
