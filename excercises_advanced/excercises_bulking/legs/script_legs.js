...
const ex1Opener=()=>{
    fadeOutAndRedirect('barbell_squats.html');
}

const ex2Opener=()=>{
    fadeOutAndRedirect('front_squats.html');
}
const ex3Opener=()=>{
    fadeOutAndRedirect('bulgarian_split_squats.html');
}

const ex4Opener=()=>{
    fadeOutAndRedirect('romanian_deadlifts_heavy_weights.html');
}

const ex5Opener=()=>{
    fadeOutAndRedirect('leg_press_heavy_weights.html');
}
