...
const ex1Opener=()=>{
    fadeOutAndRedirect('weighted_pull_ups.html');
}

const ex2Opener=()=>{
    fadeOutAndRedirect('t_bar.html');
}
const ex3Opener=()=>{
    fadeOutAndRedirect('bent_over_rows_chains.html');
}

const ex4Opener=()=>{
    fadeOutAndRedirect('single_arm_dumbbell_row.html');
}

const ex5Opener=()=>{
    fadeOutAndRedirect('deadlift_heavier_weights.html');
}
