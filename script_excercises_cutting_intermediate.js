...
const ex1Opener=()=>{
    fadeOutAndRedirect('excercises_intermediate/excercises_cutting/dumbell_lunges.html');
}

const ex2Opener=()=>{
    fadeOutAndRedirect('excercises_intermediate/excercises_cutting/kettlebell_swings.html');
}

const ex3Opener=()=>{
    fadeOutAndRedirect('excercises_intermediate/excercises_cutting/decline_bench_press.html');
}

const ex4Opener=()=>{
    fadeOutAndRedirect('excercises_intermediate/excercises_cutting/russian_twists.html');
}

const ex5Opener=()=>{
    fadeOutAndRedirect('excercises_intermediate/excercises_cutting/burpees.html');
}

const ex6Opener=()=>{
    fadeOutAndRedirect('excercises_intermediate/excercises_cutting/cable_rows.html');
}

const ex7Opener=()=>{
    fadeOutAndRedirect('excercises_intermediate/excercises_cutting/jumping_squats.html');
}

const ex8Opener=()=>{
    fadeOutAndRedirect('excercises_intermediate/excercises_cutting/mountain_climbers.html');
}
