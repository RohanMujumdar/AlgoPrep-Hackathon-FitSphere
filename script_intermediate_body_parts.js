...
const ex1Opener=()=>{
    fadeOutAndRedirect('excercises_intermediate/excercises_bulking/chest/chest.html');
}

const ex2Opener=()=>{
    fadeOutAndRedirect('excercises_intermediate/excercises_bulking/back/back.html');
}
const ex3Opener=()=>{
    fadeOutAndRedirect('excercises_intermediate/excercises_bulking/shoulders/shoulders.html');
}

const ex4Opener=()=>{
    fadeOutAndRedirect('excercises_intermediate/excercises_bulking/biceps/biceps.html');
}

const ex5Opener=()=>{
    fadeOutAndRedirect('excercises_intermediate/excercises_bulking/triceps/triceps.html');
}

const ex6Opener=()=>{
    fadeOutAndRedirect('excercises_intermediate/excercises_bulking/legs/legs.html');
}

const ex7Opener=()=>{
    fadeOutAndRedirect('excercises_intermediate/excercises_bulking/abs&cardio/abs&cardio.html');
}

const ex8Opener=()=>{
    fadeOutAndRedirect('excercises_intermediate/excercises_bulking/yoga/yoga.html');
}
