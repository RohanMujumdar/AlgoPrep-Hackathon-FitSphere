...
const ex1Opener=()=>{
    fadeOutAndRedirect('excercises_beginner/body_weights_squats.html');
}

const ex2Opener=()=>{
    fadeOutAndRedirect('excercises_beginner/push_ups.html');
}

const ex3Opener=()=>{
    fadeOutAndRedirect('excercises_beginner/jumping_jacks.html');
}

const ex4Opener=()=>{
    fadeOutAndRedirect('excercises_beginner/walking_lunges.html');
}

const ex5Opener=()=>{
    fadeOutAndRedirect('excercises_beginner/plank.html');
}

const ex6Opener=()=>{
    fadeOutAndRedirect('excercises_beginner/mountain_climbers.html');
}

const ex7Opener=()=>{
    fadeOutAndRedirect('excercises_beginner/burpees.html');
}

const ex8Opener=()=>{
    fadeOutAndRedirect('excercises_beginner/high_knees.html');
}
