...
const ex1Opener=()=>{
    fadeOutAndRedirect('excercises_beginner/bulking_excercises/wall_push_ups.html');
}

const ex2Opener=()=>{
    fadeOutAndRedirect('excercises_beginner/bulking_excercises/chair_squats.html');
}
const ex3Opener=()=>{
    fadeOutAndRedirect('excercises_beginner/bulking_excercises/seated_dumbell_press.html');
}

const ex4Opener=()=>{
    fadeOutAndRedirect('excercises_beginner/bulking_excercises/standing_dumbell_curls.html');
}

const ex5Opener=()=>{
    fadeOutAndRedirect('excercises_beginner/bulking_excercises/bent_knee_deadlift.html');
}

const ex6Opener=()=>{
    fadeOutAndRedirect('excercises_beginner/bulking_excercises/standing_calf_raises.html');
}

const ex7Opener=()=>{
    fadeOutAndRedirect('excercises_beginner/bulking_excercises/bird_dog.html');
}

const ex8Opener=()=>{
    fadeOutAndRedirect('excercises_beginner/bulking_excercises/glute_bridges.html');
}
