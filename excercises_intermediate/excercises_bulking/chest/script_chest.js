...
const ex1Opener=()=>{
    fadeOutAndRedirect('diamond_push_ups.html');
}

const ex2Opener=()=>{
    fadeOutAndRedirect('bench_press.html');
}
const ex3Opener=()=>{
    fadeOutAndRedirect('incline_bench_press.html');
}

const ex4Opener=()=>{
    fadeOutAndRedirect('decline_bench_press.html');
}

const ex5Opener=()=>{
    fadeOutAndRedirect('chest_fly.html');
}
