...
const ex1Opener=()=>{
    fadeOutAndRedirect('shoulder_press.html');
}

const ex2Opener=()=>{
    fadeOutAndRedirect('lateral_raises.html');
}
const ex3Opener=()=>{
    fadeOutAndRedirect('front_raises.html');
}

const ex4Opener=()=>{
    fadeOutAndRedirect('rear_delt_flyes.html');
}
