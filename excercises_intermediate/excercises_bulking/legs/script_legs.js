...
const ex1Opener=()=>{
    fadeOutAndRedirect('squats.html');
}

const ex2Opener=()=>{
    fadeOutAndRedirect('lunges.html');
}
const ex3Opener=()=>{
    fadeOutAndRedirect('leg_press.html');
}

const ex4Opener=()=>{
    fadeOutAndRedirect('leg_extension.html');
}

const ex5Opener=()=>{
    fadeOutAndRedirect('sumo_squat.html');
}
